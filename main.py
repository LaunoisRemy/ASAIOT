from utils import buzzer,temphumi,ecranlcd,Button
import time
...
#OR
		...
		print(id)
		time.sleep(2)
	# if (Identif.userId == 1){ #un utilisateur s'est connecté
	# 	#ecrire à l'écran le nom de l'utilisateur + choix
	# 	#on commence le processus de choix
	# }
